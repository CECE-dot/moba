<template>
  ...
  <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                ...
                <el-form-item>
                  <el-button size="samall" type="danger" @click="model.skills.splice(i,1)"> 删除</el-button>
                </el-form-item>
               </el-col>
             </el-row>
           </el-tab-pane>
             ...
             <el-row type="flex" style="flex-wrap:wrap">
               <el-col :md='12' v-for="(item,i) of model.partners" :key="i"> 
                ...
                <el-form-item>
                  <el-button size="samall" type="danger" @click="model.partners.splice(i,1)"> 删除</el-button>
                </el-form-item>
               </el-col>
             </el-row>
           </el-tab-pane>
